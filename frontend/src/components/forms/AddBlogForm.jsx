...
const AddBlogForm = ({ onAddBlog }) => {
 ...
 const handleSubmit = async (e) => {
  ...
  const newBlog = {
   title,
   description,
   image: "https://images.unsplash.com/photo-1487611459768-bd414656ea10?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDd8fGJsb2d8ZW58MHx8MHx8fDA%3D", // Hardcoded image URL
  };
